...
public class Intern extends Employee {
	...
	/*
	 * @Override public double calculateTax(Employee employee) { InternTaxCalculator
	 * internTaxCalculator = new InternTaxCalculator(); return
	 * internTaxCalculator.calculateTax(employee); }
	 */
}
